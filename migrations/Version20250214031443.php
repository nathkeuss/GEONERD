 ...
 */
final class Version20250214031443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C66BFFE9F92F3E70 ON tutorial (country_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_C66BFFE9F92F3E70 ON tutorial');
